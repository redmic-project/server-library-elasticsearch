...
public class IsolinesQueryTest extends GeoDataQueryTest {
	...
	public void getQuery_ReturnInternalQuery_IfIsDefaultQueryDTO() throws IOException, JSONException {
		...
		BoolQueryBuilder query = IsolinesQueryUtils.getQuery(geoDataQueryDTO,
				IsolinesQueryUtils.INTERNAL_QUERY, IsolinesQueryUtils.getHierarchicalQuery(geoDataQueryDTO, parentId));
