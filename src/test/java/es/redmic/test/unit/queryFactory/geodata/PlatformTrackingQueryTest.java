...
public class PlatformTrackingQueryTest extends GeoDataQueryTest {
	...
	public void getQuery_ReturnInternalQuery_IfIsDefaultQueryDTO() throws IOException, JSONException {
		...
		BoolQueryBuilder query = PlatformTrackingQueryUtils.getQuery(geoDataQueryDTO,
				PlatformTrackingQueryUtils.INTERNAL_QUERY,
				PlatformTrackingQueryUtils.getHierarchicalQuery(geoDataQueryDTO, parentId));
