...
public abstract class BaseFlagESRepository<TModel extends BaseAbstractStringES> extends RWDataESRepository<TModel> {

	protected BaseFlagESRepository(String[] index, String type) {
		super(index, type);
	}
